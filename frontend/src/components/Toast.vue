<template>
  <div class="animate-slide-in">
    <div :class="bgColor" class="text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-3 min-w-[300px]">
      <component :is="iconComponent" class="w-5 h-5 flex-shrink-0" />
      <span class="flex-1">{{ message }}</span>
      <button @click="$emit('close')" class="text-white hover:text-gray-200 flex-shrink-0">
